...
if __name__ == "__main__":
    ...
    parsed = ParseWebPage("/Users/jamespurpura/Documents/UCI17-18/INF141/Assignments/simple-search-engine/WEBPAGES_RAW/0/6")
    parsed.parse()
    parsed.print_tokens(5)
    print("-----")
    parsed2 = ParseWebPage("/Users/jamespurpura/Documents/UCI17-18/INF141/Assignments/simple-search-engine/WEBPAGES_RAW/0/7")
    parsed2.parse()
